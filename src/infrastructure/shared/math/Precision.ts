...
export class Precision {
   ...
   *
   * @example
   * Precision.toRawAmount(1.5, 9) → "1500000000"
   * Precision.toRawAmount("0.000001", 6) → "1"
   */
  static toRawAmount(
   ...
   *
   * @example
   * Precision.toHumanAmount("1500000000", 9) → Decimal(1.5)
   * Precision.toHumanAmount("1", 6) → Decimal(0.000001)
   */
  static toHumanAmount(
   ...
   */
  static toHumanAmountNumber(
    rawAmount: string | bigint,
    decimals: number,
  ): number {
    return this.toHumanAmount(rawAmount, decimals).toNumber();
  }
   ...
   *
   * @example
   * Precision.divideAmount(100, 50000) → Decimal(0.002) // $100 / $50000 BTC price
   */
  static divideAmount(
   ...
   */
  static toDecimal(value: Decimal | number | string | bigint): Decimal {
